...
//订单调度中心---拆单策略新增接口
//策略名称列表
export const orderStrategy_list = { url: service + "/api/base/configuration/orderStrategy/list" };
//根据主键获取详情
export const orderStrategy_getByPrimary = { url: service + "/api/base/configuration/orderStrategy/getByPrimary", method: "GET" };
//编辑保存
export const orderStrategy_save = { url: service + "/api/base/configuration/orderStrategy/save" };
