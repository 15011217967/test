<template>
  <el-menu
    ...
    <el-menu-item index="1" class="submenu"><span @click="exit()">{{userInfo && userInfo.name}}</span></el-menu-item>
     <!-- <el-submenu index="2" >
      <template slot="title" ><span @click="exit()">{{userInfo && userInfo.name}}</span></template>
